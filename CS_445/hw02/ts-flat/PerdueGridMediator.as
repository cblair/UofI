package com.ts.presentation.view.perdue
{
	...
	public class PerdueGridMediator extends GridMediator
	{
		public static const NAME:String		= "PGM";
		
		private var _propOrigin:Number;
		
		public function PerdueGridMediator( viewComponent:GridView, playbackProxy:PlaybackProxy, gridProxy:GridProxy, name:String = "" )
		{
