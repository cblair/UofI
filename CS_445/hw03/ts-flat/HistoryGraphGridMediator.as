package com.ts.presentation.view.graphs
{
	...
	public class HistoryGraphGridMediator extends GridMediator
	{
		public static const NAME:String		= "TSGM";
		
		private var _propOrigin:Number;
		
		public function HistoryGraphGridMediator( viewComponent:GridView, playbackProxy:PlaybackProxy, gridProxy:GridProxy, name:String = "" )
		{
