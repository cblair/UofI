...
for j=1:8
   subplot(5,2,n,'align'),errorbar(exp_data(2:nstep:nexp,1),exp_data(2:nstep:nexp,k),nsd*exp_data(2:nstep:nexp,k+1),'g','LineWidth',2)
   hold on
   subplot(5,2,n,'align'),plot(sim_data(:,1),sim_data(:,j+1),'b-');
   figfrmt;
   box off;
   title(curve_name(j,:));
...
%    extpwr=andriac150_extpwr;
   ...
   subplot(5,2,9,'align'),errorbar(gait(:,1),gait(:,40),gait(:,41),'g','LineWidth',2)
   hold on
   subplot(5,2,9,'align'),plot(best(:,1),best(:,24),'b-');
   figfrmt;
   box off;
...
for j=1:9
   subplot(5,2,n,'align'),errorbar(exp_data2(2:nstep:nexp,1),exp_data2(2:nstep:nexp,k),nsd*exp_data2(2:nstep:nexp,k+1),'g','LineWidth',2)
   hold on
   subplot(5,2,n,'align'),plot(sim_data2(:,1),sim_data2(:,j+1),'b-');
   figfrmt;
   box off;
   title(curve_name2(j,:));
